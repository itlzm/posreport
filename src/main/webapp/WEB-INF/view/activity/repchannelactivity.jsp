...
<body
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										<h3 class="form-section">渠道数据分析</h3>
										<div class="row">
											<div class="col-md-6 ">
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/activity/repchannelactivity.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
			jQuery(document).ready(function() {
				Metronic.init();
				Layout.init();
				repchannelactivity.init();
