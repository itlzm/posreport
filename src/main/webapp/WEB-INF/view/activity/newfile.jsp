				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user"><a href="javascript:;"
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li><a href="extra_profile.html"><i class="icon-user"></i>修改密码
							</a></li>
							<li><a href="page_calendar.html"><i
									class="icon-calendar"></i>重新登录 </a></li>
							<li class="divider"></li>
							<li><a href="extra_lock.html"><i class="icon-lock"></i>锁定屏幕
							</a></li>
					...
					<div class="col-md-12 " id="QueryDiv" style="display: none;">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="row form-group">
									<div class="col-md-6">
										<label class="control-label"> 品牌范围选择</label> <input
											type="hidden" class="form-control select2m" id="setBrandName">
									</div>
									<div class="col-md-6">
										<label class="control-label"> 门店范围选择</label> <input
											type="hidden" class="form-control select2m" id="setStoreName">
									</div>
							...
							<div class="portlet-title">
								...
								<div class="actions">
									<a href="javascript:;" class="btn btn-default btn-sm"
										id="btnQuery" onclick="JavaScript:fnBtnClickShowQuery()">
										<i class="fa fa-search"></i>设置条件
									</a>
									<div class="btn-group">
										<a class="btn btn-default btn-sm" href="javascript:;"
											data-toggle="dropdown"><i class="fa fa-share"> </i>数据导出 <i
											class="fa fa-angle-down"></i></a>
										<ul class="dropdown-menu pull-right">
											<li><a href="javascript:;"><i
													class="fa fa-file-pdf-o"></i>导出图表到PDF </a></li>
											<li><a href="javascript:;"><i
													class="fa fa-file-excel-o"></i>导出明细到Excel </a></li>
											<li class="divider"></li>
											<li><a href="javascript:;"><i
													class="fa fa-file-pdf-o"></i>完整导出到PDF </a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										...
										<h3 class="form-section">该功能暂未开发</h3>
    ...
    <![endif]-->
		...
		<script>
			jQuery(document).ready(function() {
				Metronic.init();
				Layout.init();
				var fid =fnGetQueryString('fid');
				fnGetMenuFunction('<%=application.getInitParameter("baseUrl")%>', fid);
			});
		</script>
		<!-- END JAVASCRIPTS -->
</body>
