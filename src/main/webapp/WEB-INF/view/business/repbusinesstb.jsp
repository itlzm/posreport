...
<body
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										...
										<h3 class="form-section">营业收入同比分析</h3>
										<div class="row">
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/business/repbusinesstb.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
