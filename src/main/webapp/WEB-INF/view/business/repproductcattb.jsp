...
<body
	...
	<div class="page-container">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="row form-group">
									...
									<div class="row form-group"  >
								<div class="col-md-6">
										<label class="control-label"> 选择同比时段</label>
										<div class="input-group pull-right" id="defaultrangetb">
											<input type="text" class="form-control"> <span
												class="input-group-btn">
												<button class="btn default date-range-toggle" type="button">
													<i class="fa fa-calendar"></i>
								...
								<div class="row form-group">
									<div class="col-md-6">
										<label class="control-label"> 已选分类范围</label> <input
											type="text" class="form-control" id="setCategoryName">
									</div>
									<div class="col-md-6">
										<label class="control-label"> 分类范围选择</label>
										<div class="input-group " id="setCategoryList">
											<input type="text" class="form-control" id="setCategoryListText">
											<span class="input-group-btn">
												<button class="btn default date-range-toggle" type="button">
													<i class="fa fa-angle-down"></i>
												</button>
								...
								<div class="row form-group" style="display: none;">
									...
									<div class="col-md-6">
										<label class="control-list"> 优惠活动选择</label><input
											type="hidden" class="form-control select2m"
											id="setfavourableName">
									</div>
								...
								<form action="#" class="horizontal-form">
									<div class="form-body">
										...
										<div class="row" style="display: none;">
											<div class="col-md-6 ">
												<div id="chart-1" class=" chart" style="height: 400px;">
												</div>
											</div>
											<div class="col-md-6 ">
												<div id="chart-2" class=" chart" style="height: 400px;">
												</div>
											</div>
										</div>
										...
										<div class="row" style="display: none;">
											<div class="col-md-12 ">
												<div id="chart-3" class=" chart" style="height: 400px;">
												</div>
											</div>
										</div>
										<h3 class="form-section">产品分类同比分析</h3>
										<div class="row">

											<div class="col-md-12 " id="DataNav"></div>
										</div>
		...
		<input id="StoreListVal" type="hidden" /> <input id="BranCode"
			type="hidden" />
		<input id="CategoryListVal" type="hidden" /> <input id="CategoryCode"
			type="hidden" />
		<!-- END FOOTER -->
    ...
    <![endif]-->
		...
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assets/global/plugins/echarts-2.2.7/js/echarts.js?v=<%=application.getInitParameter("verno")%>"
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/business/repproductcattb.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
			jQuery(document).ready(function() {
				Metronic.init();
				Layout.init();
				repproductcattb.init();
			});
		</script>
		<!-- END JAVASCRIPTS -->
</body>
