...
<body
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										...
										<h3 class="form-section">日期范围同比分析</h3>
										<div class="row">
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/business/repbusinesstbdate.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
			jQuery(document).ready(function() {
				Metronic.init();
				Layout.init();
				repbusinesstbdate.init();
			});
		</script>
		<!-- END JAVASCRIPTS -->
</body>
