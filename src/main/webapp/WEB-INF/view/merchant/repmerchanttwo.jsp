...
<body
					...
					<div class="col-md-12 " id="QueryDiv" style="display: none;">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="row form-group">
									<div class="col-md-6">
										<label class="control-list"> 商家名称</label>
										<!-- 文本输入框 -->
										<input type="text" class="form-control" id="fullName">
										<!-- 下拉选择控件 -->
										<!-- <input type="hidden" class="form-control select2m" id="fullName"> -->
									</div>
									<div class="col-md-6">
										<label class="control-list"> 联系人名称</label>
										<!-- 文本输入框 -->
										<input type="text" class="form-control" id="contractPerson">
										<!-- 下拉选择控件 -->
										<!-- <input type="hidden" class="form-control select2m" id="contractPerson"> -->
									</div>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										<h3 class="form-section">商家信息报表</h3>
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/merchant/repmerchanttwo.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
