...
<body
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control"
															placeholder="未输入用户编码" id="edtEmployNo" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-6">
														<input type="text" class="form-control"
															placeholder="未输入用户名称" id="edtEmployName" />
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">所属角色权限 </label>
													<div class="col-md-6">
														<div class="input-group">
															<input type="hidden" class="form-control select2m"
																data-placeholder="未选择权限角色" id="edtRoleID" />
															<div class="input-group-btn">
																<a class="btn default"
																	onclick="javascript:fnInitForm()"
																	id="edtRoleIDBtnRefresh"> <i class="fa fa-refresh"></i></a>
															</div>
														</div>
													</div>
												</div>
	...
	<input type="hidden" id="edtEmployeeCode" value="" />
	<!-- END FOOTER -->
	...
	<script
		...
		charset="utf-8" type="text/javascript"></script>
	<script
		src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/systemui/employee.js?v=<%=application.getInitParameter("verno")%>"
		charset="utf-8" type="text/javascript"></script>
	<script>
