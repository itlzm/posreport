...
<body
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										<h3 class="form-section">门店杯量统计报表明细数据</h3>
										<div class="row">
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/store/repsalescup.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
