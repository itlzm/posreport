...
<body
							...
							<div class="portlet-body">
								...
								<div class="row form-group">
									<div class="col-md-6">
										...
										<label class="control-label"> 排序选择</label>

										<div class="input-group">
											<select class="bs-select form-control input-small"
												id="orderByCol">
												<option value="">请选择</option>
												<option value="menuItemtNum" selected="selected">销售量</option>
												<option value="orderCount">订单量</option>
												<option value="amountPrice">销售金额</option>
												<option value="netAmountPrice">实际金额</option>
											</select><select class="bs-select form-control input-small"
												tabindex="1" id="orderBySX" style="margin-left: 16px;">
												<option value="DESC">从高到底</option>
												<option value="ASC">从低到高</option>
											</select> <select class="bs-select form-control input-small"
												tabindex="1" id="topNum" style="margin-left: 17px;">
												<option value="">全部记录</option>
												<option value="10">前10位</option>
												<option value="20">前20位</option>
												<option value="50">前50位</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="row form-group" style="display: none;">
									<div class="col-md-6">
										<label class="control-list"> 支付方式</label><input type="hidden"
											class="form-control select2m" id="setPaymentkey">
									</div>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										<h3 class="form-section">门店产品销售分析</h3>
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/store/repproductsales.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
			jQuery(document).ready(function() {
				Metronic.init();
				Layout.init();
				repproductsales.init();
