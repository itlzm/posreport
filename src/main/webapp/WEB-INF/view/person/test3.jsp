...
<body
					...
					<div class="col-md-12 " id="QueryDiv" style="display: none;">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="row form-group">
									<div class="col-md-6">
										<label class="control-list"> 执行步骤</label>
										<input	class="form-control select2m" id="setJobStep">
									</div>
								</div>
								<!-- 后续添加：*************************************************** -->
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/person/test3.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
