...
<body
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="row form-group">
									<div class="col-md-6">
										<label class="control-label"> 支付方式分类名称</label>
										<div class="input-group">
											<input type="text" class="form-control" id="paymentTypeName">
										</div>
									</div>
									<div class="col-md-6">
										<label class="control-label"> 支付方式分类名称</label> <input
											class="form-control select2m" id="setPaymentTypeName"/>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										<h3 class="form-section">支付方式字典报表</h3>
										<div class="row">
											<div class="col-md-12 ">
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/job/reppaymentkey.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
