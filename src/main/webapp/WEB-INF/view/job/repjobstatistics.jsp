...
<body
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<form action="#" class="horizontal-form">
									<div class="form-body">
										<h3 class="form-section">作业日志分析</h3>
										<div class="row">
											<div class="col-md-12 ">
										...
										<h3 class="form-section">活动营收贡献分析明细数据</h3>
										<div class="row">
    ...
    <![endif]-->
		...
		<script
			...
			charset="utf-8" type="text/javascript"></script>
		<script
			src="<%=application.getInitParameter("baseUrl")%>/assetspro/scripts/job/repjobstatistics.js?v=<%=application.getInitParameter("verno")%>"
			charset="utf-8" type="text/javascript"></script>
		<script>
			jQuery(document).ready(function() {
				Metronic.init();
				Layout.init();
				repjobstatistics.init();
			});
		</script>
		<!-- END JAVASCRIPTS -->
</body>
