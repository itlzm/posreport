...
function fnQueryData(BrandCode, StoreCode, ChannelCode, favourableName) {
	...
	$.ajax({
		type : "POST",
		dataType : "json",
		url : baseUrl + '/activity/queryRepChannelActivityBrand/',
		data : {
...
function fnExportExcel() {
	...
	exportIframe.src = baseUrl + '/activity/queryRepChannelActivityExportExcel/' + rPam;
...
var repchannelactivity = function() {
