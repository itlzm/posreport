...
function fnQueryData(BrandCode, StoreCode, ChannelName, favourableName) {
	...
	$.ajax({
		type : "POST",
		dataType : "json",
		url : baseUrl + '/business/queryRepBusinessHB/',
		data : {
...
function fnEdtBrandClick(strPrm) {
	...
	if (areaCode != "") {
		...
		$.ajax({
			type : "POST",
			dataType : "json",
			url : baseUrl + '/business/queryRepBusinessHBBrandChildren/',
			data : {
				TimeStart : dteTimeStart,
				TimeEnd : dteTimeEnd,
				BrandCode : brandCode,
	...
	if (areaCode != "") {
		...
		if (isStore == "N") {
			...
			$.ajax({
				...
				dataType : "json",
				url : baseUrl
						+ '/business/queryRepBusinessHBBrandChildrenStore/',
				data : {
					TimeStart : dteTimeStart,
					TimeEnd : dteTimeEnd,
					BrandCode : brandCode,
...
function fnExportExcel() {
	...
	exportIframe.src = baseUrl + '/business/queryRepBusinessHBBrandChildrenStoreExportExcel/' + rPam;
