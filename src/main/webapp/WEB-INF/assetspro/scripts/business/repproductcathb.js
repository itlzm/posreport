...
function fnQueryData(BrandCode, StoreCode, ChannelName, favourableName,
	...
	$.ajax({
		type : "POST",
		dataType : "json",
		url : baseUrl + '/business/queryRepProductCatHBBrand/',
		data : {
...
function fnEdtBrandClick(strPrm) {
	...
	if (areaCode != "") {
		...
		$.ajax({
			type : "POST",
			dataType : "json",
			url : baseUrl + '/business/queryRepProductCatHBBrandChildren/',
			data : {
				TimeStart : dteTimeStart,
				TimeEnd : dteTimeEnd,
				BrandCode : brandCode,
		...
		if (isStore == "N") {
			...
			$
					.ajax({
						...
						dataType : "json",
						url : baseUrl
								+ '/business/queryRepProductCatHBBrandChildrenProduct/',
						data : {
							TimeStart : dteTimeStart,
							TimeEnd : dteTimeEnd,
							BrandCode : brandCode,
...
function fnExportExcel() {
	...
	exportIframe.src = baseUrl
			+ '/business/queryRepProductCatHBBrandChildrenProductExportExcel/'
			+ rPam;
}
