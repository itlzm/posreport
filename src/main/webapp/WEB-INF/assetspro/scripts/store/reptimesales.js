...
function fnQueryData(BrandCode, StoreCode, ChannelName) {
	...
	type : "POST",
	dataType : "json",
	url : baseUrl + '/store/queryRepTimeSales/',
	data : {
...
function fnExportExcel() {
	...
	exportIframe.src = baseUrl + '/store/queryRepTimeSalesExportExcel/' + rPam;
